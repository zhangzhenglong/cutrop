    ...
    ***************************************************************************** */
    ...
    var GameData = (function () {
        function GameData() {
            ...
            this.ttMinigameResUrl = 'https://package.32yx.com/ecy_game_small/laya/cutRope/tt_res/';
            this.ttMiniGameResUrl = "https://package.32yx.com/ecy_game_small/laya/cutRope/tt_res/tt_res_v_z_1_0_1/";
            this.gameId = "1038";
            this.videoTips = "视频观看完整才能获得奖励哦";
            this.gameVersion = 1013;
    ...
    var PlatformDY = (function () {
        ...
        PlatformDY.getGameList = function () {
            return new Promise(function (resolve) {
                var url = PlatformDY.url + "&act=gamelist&version=" + PlatformDY.version + "&openid=" + PlatformDY.openid;
        ...
        PlatformDY.url = "https://fx.xyxapi.com/home/index.php?webid=16";
        PlatformDY.qqUrl = "https://qq.xyxapi.com/home/jjxpy/index.php?webid=16";
        PlatformDY.ttUrl = "https://fxqq.xyxapi.com/home/?webid=10";
    ...
    */
    ...
    var MiniGameManager = (function () {
        ...
        MiniGameManager.prototype.initMiniGame = function () {
            ...
            if (DeviceUtil.isTTMiniGame()) {
                this.shareInfo[0].title = "这是一款趣味益智游戏！";
            }
            platform.onShareAppMessage(function () {
                if (DeviceUtil.isTTMiniGame()) {
                    _this.defaultMssage.title = "这是一款趣味益智游戏！";
                }
        ...
        MiniGameManager.prototype.playViderAd = function (data) {
            if (!DeviceUtil.isWXMiniGame() && !DeviceUtil.isQQMiniGame() && !DeviceUtil.isUCMiniGame() && !DeviceUtil.isTTMiniGame()) {
        ...
        MiniGameManager.prototype.initGameRecordListener = function (callBack) {
            var _this = this;
            if (!DeviceUtil.isTTMiniGame()) {
                return;
            }
            ...
            recorder.onStop(function (res) {
                ...
                callBack && callBack();
                if (now - MiniGameManager.instance.startTime < 3000) {
                    MiniGameManager.instance.tempVideoPath = null;
                    platform.showModal({
                ...
                MiniGameManager.instance.tempVideoPath = res.videoPath;
                console.log('onstop ', MiniGameManager.instance.tempVideoPath);
            });
        ...
        MiniGameManager.prototype.loopTime = function () {
            this.indexTime++;
        ...
        MiniGameManager.prototype.startGameRecord = function () {
            if (!DeviceUtil.isTTMiniGame()) {
                return;
            }
        ...
        MiniGameManager.prototype.stopGameRecord = function () {
            if (!DeviceUtil.isTTMiniGame()) {
                return;
            }
            if (this.isMakeVideo) {
                ...
                MiniGameManager.instance.recordStopFun && MiniGameManager.instance.recordStopFun();
                platform.getGameRecorderManager().stop();
            }
            console.log("stopGameRecord");
        };
        MiniGameManager.prototype.shareGameVideo = function (data) {
            if (!this.tempVideoPath || this.tempVideoPath.length == 0) {
                TipsManager.instance.showDefaultTips("暂未录制视频哦!");
                return;
            }
            if (!DeviceUtil.isTTMiniGame()) {
                return;
            ...
            obj.success = function () {
                console.log("视频分享成功！");
                data && data.successFun && data.successFun();
            };
            obj.fail = function (res) {
                console.log("视频分享失败！", res);
                data && data.failFun && data.failFun();
                TipsManager.instance.showDefaultTips("视频分享失败！");
            };
            platform.shareVideo(obj);
        };
        MiniGameManager.prototype.showMoreGamesModal = function () {
            var appLaunchOptions = [];
            for (var i = 0, len = PlatformDY.gameListInfos.length; i < len; i++) {
                appLaunchOptions.push({
                    appId: PlatformDY.gameListInfos[i].appid,
                    query: PlatformDY.gameListInfos[i].url,
                    extraData: {}
                });
            }
            function onNavigateToMiniProgram(res) {
                console.log(res.errMsg);
            }
            platform.onMoreGamesModalClose(function onClose() {
                platform.offMoreGamesModalClose(onClose);
                platform.offNavigateToMiniProgram(onNavigateToMiniProgram);
            });
            platform.onNavigateToMiniProgram(onNavigateToMiniProgram);
    ...
    var GameEvent = (function () {
        ...
        GameEvent.CLOSE_LEVEL_VIEW = "CLOSE_LEVEL_VIEW";
        return GameEvent;
    }());
    ...
    var GameLoadingView = (function (_super) {
        ...
        function GameLoadingView() {
            ...
            if (DeviceUtil.isTTMiniGame()) {
                logo.skin = "resource/assets/loading/loading_tt_1.png";
            }
            else {
    ...
    var GameScene = (function (_super) {
        ...
        GameScene.prototype.showBtn = function () {
            ...
            this.img_level.visible = true;
            this.tt_video.visible = true;
            if (DeviceUtil.isTTMiniGame()) {
                var self_1 = this;
                self_1.tt_video.getChildAt(0).visible = true;
                MiniGameManager.instance.startGameRecord();
                MiniGameManager.instance.recordStopFun = function () {
                    self_1.tt_video.getChildAt(0).visible = false;
                };
                MiniGameManager.instance.hideBanner();
            }
        };
    ...
    var SettlementView = (function (_super) {
        ...
        SettlementView.prototype.onEnabled = function () {
            _super.prototype.onEnabled.call(this);
            if (DeviceUtil.isTTMiniGame()) {
                MiniGameManager.instance.stopGameRecord();
                this.tt_isShareVideo = false;
                var numberChi = this.btn_ttShare.numChildren;
                this.btn_ttShare.getChildAt(0).x = 24;
                this.btn_ttShare.getChildAt(1).x = 112;
                this.btn_ttShare.getChildAt(numberChi - 1).visible = true;
                this.btn_ttShare.getChildAt(numberChi - 2).visible = true;
            }
            if ((DeviceUtil.isQQMiniGame() || DeviceUtil.isTTMiniGame()) && GameData.getInstance().isWDJOpenBox) {
                MiniGameManager.instance.hideBanner();
            }
        ...
        SettlementView.prototype.addEvent = function () {
            ...
            this.btn_ttShare.on(Laya.Event.CLICK, this, this.onShare);
        ...
        SettlementView.prototype.initView = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    if (!this.data)
                        return [2];
                    if (DeviceUtil.isTTMiniGame() || DeviceUtil.isWXMiniGame() && PlatformDY.gameListInfos != null && PlatformDY.gameListInfos.length > 0) {
                        if (!GameData.getInstance().isConVersion) {
                    ...
                    if (this.data == 1) {
                        ...
                        this.btn_ttShare.visible = false;
                        ...
                        if (DeviceUtil.isTTMiniGame()) {
                            this.btn_video.centerX = 260;
                            this.btn_ttShare.visible = true;
                            this.btn_share.visible = false;
                            if (GameData.getInstance().isConVersion) {
                                this.btn_ttShare.centerX = 0;
                            }
                        }
        ...
        SettlementView.prototype.onShare = function () {
            ...
            if (DeviceUtil.isWXMiniGame() || DeviceUtil.isUCMiniGame()) {
                ...
                var self_1 = this;
                MiniGameManager.instance.shareGameVideo({
                    successFun: function () {
                        if (self_1.tt_isShareVideo) {
                            TipsManager.instance.showDefaultTips("奖励已获取！");
                            return;
                        }
                        TipsManager.instance.showDefaultTips("恭喜获得体力 +3");
                        GameManager.instance.changePower({ count: 3, isNatural: false });
                        self_1.tt_isShareVideo = true;
                        var numberChi = self_1.btn_ttShare.numChildren;
                        self_1.btn_ttShare.getChildAt(0).x = 60;
                        self_1.btn_ttShare.getChildAt(1).x = 180;
                        self_1.btn_ttShare.getChildAt(numberChi - 1).visible = false;
                        self_1.btn_ttShare.getChildAt(numberChi - 2).visible = false;
                    }
                });
            }
            else {
        ...
        SettlementView.prototype.removeEvent = function () {
            ...
            this.btn_ttShare.off(Laya.Event.CLICK, this, this.onShare);
    ...
    var LevelView = (function (_super) {
        ...
        LevelView.prototype.addEvent = function () {
            ...
            EventMgr.getInstance().addEvent(GameEvent.CLOSE_LEVEL_VIEW, this, this.removeSelf);
        };
        ...
        LevelView.prototype.removeEvent = function () {
            ...
            EventMgr.getInstance().removeEvent(GameEvent.CLOSE_LEVEL_VIEW, this, this.removeSelf);
        };
    ...
    var HomeScene = (function (_super) {
        ...
        HomeScene.prototype.childrenCreated = function () {
            if (DeviceUtil.isQQMiniGame() || DeviceUtil.isUCMiniGame() || DeviceUtil.isTTMiniGame()) {
        ...
        HomeScene.prototype.toLevelGame = function (toLevelid) {
            ...
            GameManager.instance.changePower({
                count: -1, success: function () {
                    ...
                    GameMgr.getInstance().startGame();
                    EventMgr.getInstance().sendEvent(GameEvent.CLOSE_LEVEL_VIEW);
                }, fail: function () {
                }
            });
        };
        ...
        HomeScene.prototype.initGameScene = function () {
            if (DeviceUtil.isTTMiniGame()) {
                this.img_logo.skin = "resource/assets/loading/loading_tt_1.png";
            }
            else {
    ...
    var Main = (function (_super) {
        ...
        Main.prototype.checkPlatform = function () {
            ...
            var fileLocalList = [
                ...
                "resource/assets/loading/loading_tt_1.png",
            ...
            if (DeviceUtil.isQQMiniGame()) {
                ...
                PlatformDY.url = PlatformDY.ttUrl;
                PlatformDY.miniProgramList = PlatformDY.ttMiniProgramList;
                Laya.MiniAdpter.nativefiles = fileLocalList;
                Laya.MiniAdpter.init();
            ...
            if (DeviceUtil.isQQMiniGame() || DeviceUtil.isWXMiniGame() || DeviceUtil.isTTMiniGame() || DeviceUtil.isUCMiniGame()) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (DeviceUtil.isTTMiniGame()) {
                                url = GameData.getInstance().ttMinigameResUrl;
                            }
        ...
        Main.prototype.enableFileConfig = function (resUrl) {
            ...
            Laya.AtlasInfoManager.enable(resUrl + "fileconfig.json?v=" + GameMgr.getInstance().randomTime, Laya.Handler.create(this, function () { return __awaiter(_this, void 0, void 0, function () {
                var loadresUrl, uc_userInfo, res, code, uc_openid, setInfo, auth, boxId, self_1, enterGame_1, code, isAuthorize, userinfo, obj, scene, infos;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 18:
                            ...
                            if (!DeviceUtil.isTTMiniGame()) return [3, 20];
                            MiniGameManager.instance.showBannerAd();
                            Laya.URL.basePath = GameData.getInstance().ttMiniGameResUrl;
                            self_1 = this;
                            enterGame_1 = function (iscreate) {
                                if (iscreate === void 0) { iscreate = false; }
                                if (iscreate) {
                                    GameData.getInstance().userInfo.openId =
                                        GameData.getInstance().userInfo.sessionKey =
                                            GameData.getInstance().userInfo.nick =
                                                GameData.getInstance().userInfo.avatarUrl = DeviceUtil.getDeviceNo();
                                }
                                self_1.netDataSucc = true;
                                self_1.loadRes();
                            };
                            return [4, this.ttLogin(function (flag) {
                                    enterGame_1(flag);
                                })];
                        case 19:
                            _a.sent();
                            return [2];
                        case 20:
                            if (!(DeviceUtil.isQQMiniGame() || DeviceUtil.isWXMiniGame())) return [3, 25];
                            MiniGameManager.instance.showBannerAd();
        ...
        Main.prototype.ttLogin = function (callBack) {
            return __awaiter(this, void 0, void 0, function () {
                var code, userinfo, obj, scene;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, platform.DYlogin()];
                        case 1:
                            code = _a.sent();
                        ...
                        case 2:
                            ...
                            obj = GameData.getInstance().enterGameInfo;
                            scene = obj.query.scene == undefined ? null : obj.query.scene;
                            if (!(code != null)) return [3, 4];
                            return [4, PlatformDY.getOpenidAndAuthorzia({
                                    code: code, nickName: userinfo.nickName, avatarUrl: userinfo.avatarUrl, gender: userinfo.gender, scene: decodeURIComponent(scene)
                                }).then(function (dyUser) {
                                    GameData.getInstance().userInfo.openId = dyUser.openid;
                                    EventMgr.getInstance().sendEvent("openid_succ");
